...
- Time window: LOOK_BACK=5.0s before seg start, LOOK_FORWARD=1.0s after seg end (asymmetric interval overlap — enforces causality)
- Similarity: >55% word overlap (directional — matched words / Speaker 1 word count)
- Guard: segments ≤2 words (total word count) are never dropped
